#import "TradPlusBigoInterstitialAdapter.h"
...
@interface TradPlusBigoInterstitialAdapter ()<BigoInterstitialAdLoaderDelegate,BigoAdInteractionDelegate,TPSDKLoaderDelegate>
...
@implementation TradPlusBigoInterstitialAdapter
...
- (void)loadAd
{
    BigoInterstitialAdRequest *request = [[BigoInterstitialAdRequest alloc] initWithSlotId:self.placementId];
    self.adLoader = [[BigoInterstitialAdLoader alloc] initWithInterstitialAdLoaderDelegate:self];
...
- (BOOL)isReady
{
    return !self.interstitialAd.isExpired;
}
...
- (void)onInterstitialAdLoadError:(BigoAdError *)error
{
    ...
    NSError *loadError = [NSError errorWithDomain:@"Bigo.interstitial" code:errorCode userInfo:@{NSLocalizedDescriptionKey:errorMsg}];
...
- (void)onAd:(BigoAd *)ad error:(BigoAdError *)error
{
    ...
    NSError *showError = [NSError errorWithDomain:@"Bigo.interstitial" code:errorCode userInfo:@{NSLocalizedDescriptionKey:errorMsg}];
