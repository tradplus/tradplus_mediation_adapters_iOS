#import "TradPlusTapjoyRewardedAdapter.h"
...
@interface TradPlusTapjoyRewardedAdapter ()<TJPlacementDelegate,TJPlacementVideoDelegate,TPSDKLoaderDelegate>
...
@implementation TradPlusTapjoyRewardedAdapter
...
{
    MSLogTrace(@"%s %@", __PRETTY_FUNCTION__,errorMsg);
    NSError *error = [NSError errorWithDomain:@"Tapjoy" code:406 userInfo:@{NSLocalizedDescriptionKey:errorMsg}];
